...
def calculate_frequencies(file_contents):
    ...
    answer = {}
    # split into array of words (with punctuation and rest)
    array_file = file_contents.split()
    # create list of punctuation characters
    punctuations = list(punctuations)
    

    for word in array_file:
        #lowercase every word 
        word = word.lower()        
        for char in word:
            # check if it is punctuation remove it from word
            if char in punctuations:
                word = word.replace(char, '')
        # don't count uniinteresting words
